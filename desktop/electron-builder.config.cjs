...
module.exports = {
  ...
  files: ["main.mjs", "preload.cjs", "auto-update.mjs", "update-notice.mjs", "deck-link.mjs", "deck-host.mjs", "nav.mjs", "updater.mjs", "updater-mac.mjs", "dist/icons/**", "dist/lib/**", "package.json"],
